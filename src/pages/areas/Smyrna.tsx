...
export default function Smyrna() {
  return (
    <div className="min-h-screen pt-24">
      <SEO
        title="Contractor Smyrna GA | Kitchen Remodeling, Bathroom Renovations & Home Remodeling | Phoenix Construction"
        description="Phoenix Construction serves Smyrna GA with expert kitchen remodeling, bathroom renovations, basement finishing, and new home construction. Call (678) 463-4893 for a free estimate."
        canonical="/smyrna"
        breadcrumbs={[{ name: 'Home', url: '/' }, { name: 'Smyrna', url: '/smyrna' }]}
        localBusiness={{ cityName: 'Smyrna', citySlug: 'smyrna', services: ['Kitchen Remodeling', 'Bathroom Remodeling', 'Basement Finishing', 'Custom Home Construction', 'Roofing', 'Deck Installation'], latitude: 33.8840, longitude: -84.5144 }}
      />
